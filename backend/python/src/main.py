...
async def get_interview_questions(
    ...
    """Get scraped interview questions."""
    try:
        # Force refresh of scraped questions
        problem_generator.refresh_scraped_questions()
        
        # Filter by source if specified
        questions = problem_generator.scraped_questions
        if source:
